...
globalReactivePower <- as.numeric(partitionedData$Global_reactive_power)
voltage <- as.numeric(partitionedData$Voltage)
subMetering1 <- as.numeric(partitionedData$Sub_metering_1)
subMetering2 <- as.numeric(partitionedData$Sub_metering_2)
subMetering3 <- as.numeric(partitionedData$Sub_metering_3)
